export const demoAccounts = Object.freeze([
  ...
  Object.freeze({ role: "operator", label: "操作员", description: "日常数据接入、对账运行和异常查看", email: "operator@hyperrecon.local", password: "HyperRecon-Operator-2026!" }),
  Object.freeze({ role: "reviewer", label: "复核人", description: "复核结果、创建和锁定月结期间", email: "reviewer@hyperrecon.local", password: "HyperRecon-Reviewer-2026!" }),
