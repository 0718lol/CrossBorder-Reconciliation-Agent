export const roleProfiles = Object.freeze({
  admin: profile({
    ...
    navigation: { overview: "资金驾驶舱", sources: "数据接入", runs: "对账运行", exceptions: "异常队列", periods: "月结中心", audit: "审计记录" },
    capabilities: ["upload", "run", "period_create", "period_close", "audit_read"], reads: ["periods", "audit"],
  }),
  operator: profile({
  ...
  reviewer: profile({
    ...
    capabilities: ["period_create", "period_close"], reads: ["periods"],
  }),
  auditor: profile({
